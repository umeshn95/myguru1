...
const Testpage10thint = () => {
    ...
    const sendDataResult = (industry, question, id) => {
        ...
        fetch(`${process.env.REACT_APP_API_URL}/api/10th/int/testresult`, {
            // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/7th/testresult", {
            method: "POST",
            headers: {
    ...
    const getAns = () => {
        ...
        fetch(`${process.env.REACT_APP_API_URL}/api/10th/int/question`, {
            // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/7th/question", {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
    ...
    const deleteData = () => {
        ...
        // const token = user.access;
        setLoading(true)
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/7th/deleteresult", {
    ...
    const pagination = (pk) => {
        ...
        setCount(k)
        setLoading(true)
        // fetch(`https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/7th/question?page=${k}`, {
