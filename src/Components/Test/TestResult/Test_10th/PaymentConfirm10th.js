                            ...
                            <div className="full">
                                ...
                                <div className="full mt-3 col-lg-5 col-sm-12 back_payment2 float-left ml-5">
                                    ...
                                    <div className="paymnt">
                                        ...
                                        <Link to='/10th/paymentassessment'><a><button className="btn proceed_test">Proceed to test</button></a></Link>
                                    </div>
...
export default PaymentConfirm10th
