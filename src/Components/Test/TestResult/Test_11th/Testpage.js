...
const Testpage = () => {
    ...
    const sendDataResult = (industry, question, id) => {
        ...
        console.log(id)
        setLoading(true)
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/testresult", {
    ...
    const getAns = () => {
        setLoading(true)
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/question", {
    ...
    const deleteData = () => {
        ...
        // const token = user.access;
        setLoading(true)
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/deleteresult", {
    ...
    const pagination = (pk) => {
        ...
        setCount(k)
        setLoading(true)
        // fetch(`https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/question?page=${k}`, {
