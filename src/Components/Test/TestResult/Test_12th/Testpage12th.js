                                                        ...
                                                        <div classNameName="col mt-3">
                                                            ...
                                                            <form action="" className=" d-flex justify-content-center">
                                                                <ul className="row box_text ">
                                                                    ...
                                                                    <li className="col-lg-12">(b) {e.b} <input className="float-right mt-3" type="radio" value={ans2} onChange={() => setAns2(2)} /></li>
                                                                    <li className="col-lg-12">(c) {e.c} <input className="float-right mt-3" type="radio" value={ans3} onChange={() => setAns3(3)} /></li>
                                                                    {/* <li className="col-lg-12">(c) {e.c} <input className="float-right mt-3" type="checkbox" id="flexCheckDefault" name={e.id} value={e.ans3} onChange={handleChange} /></li> */}
                                                                    {
                                                                        e.d ?
                                                                            <>
                                                                                <li className="col-lg-12">(d) {e.d} <input className="float-right mt-3" type="radio" value={ans4} onChange={() => setAns4(4)} /></li>
                                                                            </>
                                                                            :
                                                                            <>
                                                                            </>
                                                                    }
                                                                    {
                                                                        e.e ?
                                                                            <>
                                                                                <li className="col-lg-12">(e) {e.e} <input className="float-right mt-3" type="radio" value={ans5} onChange={() => setAns5(5)} /></li>
                                                                            </>
                                                                            :
                                                                            <>
                                                                            </>
