...
const Testpage12th = () => {
    ...
    const sendDataResult = (industry, question, id) => {
        ...
        setLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/api/12th/testresult`, {
            method: "POST",
            headers: {
    ...
    const getAns = () => {
        setLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/api/12th/question`, {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
    ...
    const deleteData = () => {
        fetch(`${process.env.REACT_APP_API_URL}/api/12th/deleteresult`, {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
    ...
    const pagination = (pk) => {
        ...
        setCount(k)
        setLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/api/12th/question?page=${k}`, {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
                                                    ...
                                                    <div classNameName="col mt-3">
                                                        ...
                                                        <form action="" className=" d-flex justify-content-center">
                                                            <ul className="row box_text ">
                                                                ...
                                                                <li className="col-lg-12"><span style={{ float: "left" }}>(b) {e.b}</span> <input className="float-right mt-3" type="radio" value={ans2} onChange={() => setAns2(2)} /></li>
                                                                <li className="col-lg-12"><span style={{ float: "left" }}>(c) {e.c}</span> <input className="float-right mt-3" type="radio" value={ans3} onChange={() => setAns3(3)} /></li>
                                                                {/* <li className="col-lg-12">(c) {e.c} <input className="float-right mt-3" type="checkbox" id="flexCheckDefault" name={e.id} value={e.ans3} onChange={handleChange} /></li> */}
                                                                {
                                                                    e.d ?
                                                                        <>
                                                                            <li className="col-lg-12"><span style={{ float: "left" }}>(d) {e.d}</span> <input className="float-right mt-3" type="radio" value={ans4} onChange={() => setAns4(4)} /></li>
                                                                        </>
                                                                        :
                                                                        <>
                                                                        </>
                                                                }
                                                                {
                                                                    e.e ?
                                                                        <>
                                                                            <li className="col-lg-12"><span style={{ float: "left" }}>(e) {e.e}</span> <input className="float-right mt-3" type="radio" value={ans5} onChange={() => setAns5(5)} /></li>
                                                                        </>
                                                                        :
                                                                        <>
                                                                        </>
