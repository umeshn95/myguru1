...
const Testpage6To9 = () => {
    ...
    const sendDataResult = (industry, question, id) => {
        ...
        console.log(item)
        setLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/api/9th/testresult`, {
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/9th/testresult", {
            method: "POST",
            headers: {
    ...
    const getAns = () => {
        setLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/api/9th/question`, {
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/9th/question", {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
    ...
    const getData = () => {
        ...
        setLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/api/9th/studentquestion`, {
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/9th/studentquestion", {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
    ...
    const deleteData = () => {
        ...
        // const token = user.access;
        setLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/api/9th/deleteresult`, {
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/9th/deleteresult", {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
    ...
    const pagination = (pk) => {
        ...
        setCount(k)
        setLoading(true)
        fetch(`${process.env.REACT_APP_API_URL}/api/9th/question?page=${k}`, {
        // fetch(`https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/9th/question?page=${k}`, {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
