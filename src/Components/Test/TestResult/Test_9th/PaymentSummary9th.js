...
const PaymentSummary6To9 = () => {
    ...
    const getData = () => {
        ...
        setLoading(true)
        fetch(`${env.REACT_APP_API_URL}/api/9th/studentquestion`, {
        // fetch("https://myguruonline.herokuapp.com/api/9th/studentquestion", {
            method: "GET",
            headers: {
                                        ...
                                        <div className="float-right mr-5">
                                            ...
                                            }
                                            {
                                                data.length === 0 ?
                                                    ...
                                                    :
                                                    <>
                                                        <Link to="/9th/paymentassessment"><button className="pay_btn float-right mr-5">Pay</button></Link>
                                                    </>
                                            }
                                        </div>
                                    </div>
...
export default PaymentSummary6To9
