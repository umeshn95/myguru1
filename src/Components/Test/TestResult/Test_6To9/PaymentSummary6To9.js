...
const PaymentSummary6To9 = () => {
    ...
    const getData = () => {
        ...
        // fetch("https://myguruonline.herokuapp.com/api/6to9/studentquestion", {
            method: "GET",
            headers: {
                                        ...
                                        <div className="float-right mr-5">
                                            ...
                                            }
                                            {
                                                data.length === 0 ?
                                                    ...
                                                    :
                                                    <>
                                                        <Link to="/6th/paymentassessment"><button className="pay_btn float-right mr-5">Pay</button></Link>
                                                    </>
                                            }
                                        </div>
                                    </div>
