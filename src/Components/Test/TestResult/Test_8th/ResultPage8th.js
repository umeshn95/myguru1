...
const ResultPage6To9 = () => {
    ...
    const getCarrer = () => {
        ...
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/8th/result", {
            method: "GET",
            headers: {
    ...
    const GradeData = () => {
        ...
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/8th/showgrade/", {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
    ...
    const getIndustry = () => {
        ...
        // fetch("https://myguruonline.herokuapp.com${process.env.REACT_APP_API_URL}/api/8th/showindusty/", {
            method: "GET",
            headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
