                            ...
                            <div className="full mt-5">
                                ...
                                <div className="full mt-3 back_payment">
                                    ...
                                    <div className="float-right mr-5">
                                        <img style={{ width: "220px" }} className="img-fluid" src="/assets/images/logo.png" alt="image" />
                                        {
                                            data.map((e, i) =>
                                        ...
                                        }
                                        {
                                            data.length === 0 ?
                                                ...
                                                :
                                                <>
                                                    <Link to="/8th/paymentconfirm"><button className="pay_btn float-right mr-5">Pay</button></Link>
                                                </>
                                        }
                                    </div>
                                </div>
